...
import com.backend.odontologia.model.Domicilio;
...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    @Override
    public Iterable<Domicilio> listar() {
        Connection connection = null;
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                Domicilio domicilio = crearObjDomicilio(resultSet);
    ...
    private Domicilio crearObjDomicilio(ResultSet resultSet) throws SQLException {
